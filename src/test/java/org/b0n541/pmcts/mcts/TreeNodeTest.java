...
public class TreeNodeTest {
    ...
    public void rootNode() {
        ...
        assertThat(rootNode.getUcb1Value(0)).isEqualTo(Double.MAX_VALUE);
    }
    ...
    public void visitNodes() {
        ...
        assertThat(leftChildNode.getUcb1Value(0)).isEqualTo(Double.MAX_VALUE);
        ...
        assertThat(leftChildNode.getUcb1Value(0)).isEqualTo(20.0);
        ...
        assertThat(rightChildNode.getUcb1Value(0)).isEqualTo(Double.MAX_VALUE);
        ...
        assertThat(leftChildNode.getTotalScores()).isEqualTo(new double[]{20.0, 0.0});
        assertThat(leftChildNode.getVisits()).isEqualTo(1);
        assertThat(leftChildNode.getUcb1Value(0)).isCloseTo(21.67, within(0.01));

        assertThat(rightChildNode.getTotalScores()).isEqualTo(new double[]{10.0, 0.0});
        assertThat(rightChildNode.getVisits()).isEqualTo(1);
        assertThat(rightChildNode.getUcb1Value(0)).isCloseTo(11.67, within(0.01));
        ...
        assertThat(leftChildNode.getUcb1Value(0)).isCloseTo(18.98, within(0.01));

        assertThat(rightChildNode.getTotalScores()).isEqualTo(new double[]{10.0, 0.0});
        assertThat(rightChildNode.getVisits()).isEqualTo(1);
        assertThat(rightChildNode.getUcb1Value(0)).isCloseTo(12.10, within(0.01));
        ...
        assertThat(leftGrandChildNode.getUcb1Value(0)).isCloseTo(16.67, within(0.01));
        ...
        assertThat(rightGrandChildNode.getUcb1Value(0)).isEqualTo(Double.MAX_VALUE);
    }
}
